...
<Nav direction="row" background="" pad="">
    ...
    <Button className="navbutton" href="/player_stats" icon={<Sort color='#ffb81c' size='large' />} />
    <Button className="navbutton" href="/team_stats" icon={<Analytics color='#ffb81c' size='large' />} />
